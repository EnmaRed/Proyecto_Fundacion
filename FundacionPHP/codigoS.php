...
<body>
    ...
    <a href="" class="btn-flotante"  id="btnCarrito"> Ir al Formulario <span class="badge bg-success" id="carrito">0</span></a>
    <!-- Navigation-->
        ...
        <header class="bg-warning py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                  <picture> <img src='img/perrito.jpg' class="fotoperro"></picture>
                    <p class="display-2 fw-bolder"> Nuestras Mascotas</p>
                    <p class="lead fw-normal text-white  mb-0"> <strong> Te presentamos a tu próxima mascota </strong> </p>
                </div>
            </div>
        </header>
                        ...
                        <div class="col mb-5 productos" category="<?php echo $data['categoria']; ?>">
                            <div class="card h-100">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto agregar" data-id="<?php echo $data['id']; ?>" href="#">Adoptar</a></div>
                                </div>
                            </div>
                        </div> 
                <?php  }
