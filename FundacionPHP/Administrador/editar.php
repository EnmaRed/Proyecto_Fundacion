...
if (isset($_GET['id'])) {
    ...
    if (isset( 
        ...
        $query = mysqli_query($coneccion, "UPDATE productos SET 
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="edad"><?php echo $producto['edad']; ?></textarea>
            </div>

           
            <div class="form-group">
                <label for="vacunas">vacunas:</label>
                <input type="text" class="form-control" name="vacunas" value="<?php echo $producto['vacunas']; ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="peso_gramos" ><?php echo $producto['peso_gramos']; ?></textarea>
            </div>

            
            <div class="form-group">
                <label for="genero">Género:</label>
                <textarea class="form-control" name="genero" ><?php echo $producto['genero']; ?></textarea>
            </div>

            <div class="form-group">
                <label for="estatura">estatura:</label>
                <textarea class="form-control" name="estatura" ><?php echo $producto['estatura']; ?></textarea>
            </div>

            <div class="form-group">
                <label for="raza">raza:</label>
                <textarea class="form-control" name="raza" ><?php echo $producto['raza']; ?></textarea>
            </div>

            <div class="form-group">
                <label for="especie">especie:</label>
                <textarea class="form-control" name="especie" ><?php echo $producto['especie']; ?></textarea>
            </div>
